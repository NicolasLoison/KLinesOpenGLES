...
public class MyGLRenderer implements GLSurfaceView.Renderer {
    ...
    public void onSurfaceCreated(GL10 unused, EGLConfig config) {
        ...
        mTextureDataHandle = Square.loadTexture(context, R.mipmap.red_icon);
    ...
    public void onDrawFrame(GL10 unused) {
       ...
       // Matrix.setLookAtM(mViewMatrix, 0, 0, 0, -3, 0f, 0f, 0f, 0f, 1.0f, 0.0f);
        ...
        Log.d("Renderer", "mSquarex"+ mSquarePosition[0]);
        Log.d("Renderer", "mSquarey"+ mSquarePosition[1]);
    ...
    public void onSurfaceChanged(GL10 unused, int width, int height) {
        ...
        Matrix.orthoM(mProjectionMatrix, 0, -10.0f, 10.0f, -(10.0f*(height/width)), (10.0f*(height/width)), -1.0f, 1.0f);
    }
